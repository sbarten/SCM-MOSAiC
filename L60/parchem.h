...
C     see "prechem.f")
     ...
     +        NTR,NSPEC_EMISVOC,NRESUM,NCCTILES
...
C              monoterpene (terpinolene) NTRACT=63 with NTRAC=47
      ...
      PARAMETER (NLEVV=4,NLEVV_ML=2,NLEVS_ML=NLEVV_ML,NLEVATM=60,
     +           NLEVT=NLEVATM+NLEVV,
     +           NNLON=1,NLONT30=96,NLATT30=48,NLONT21=64,NLATT21=32,
     +           NLEV_TM3=19,NTR=100,NSPEC_EMISVOC=9,  ! ESS_lg_20070802+ 9 VOC emission species ! ESS_lg_20100326+ updated NTR
     +           NRESUM=0,NCCTILES=1, ! mz_lg_20060628+
     +           NTRAC_ECH=24,NTRAC_CBM4_ECH=63,NTRAC_CBM4_TM3=38,NTRAC_TM3=30,
     +           NTRAC_CHEM_MIM=42,NTRAC_MECCA1=68,  ! ESS_lg_20100225+ added NTRAC_MECCA, the number should resemble the parameter NSPEC in messy_mecca_kpp_g_mem 
     +           NTRAC=63,NG3X=0,NTRACT=NTRAC+NG3X)  ! ESS_lg_20100301+ moved to here the final assignment of the actual no. of tracers, NTRAC     
