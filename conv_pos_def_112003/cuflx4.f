...
C     
     ...
     *     KDTOP(KLP2),            KTYPE(KLP2)
      ...
      LOGICAL  ldp(KLP2,klev) ! op_ck_20031001
...
C     LG- adding the tracers
     ...
     *     PMFUXT(KLON,KLEV,KTRAC),  PMFDXT(KLON,KLEV,KTRAC)
      ...
      REAL zmass(KLON,klev),  zpmfun(KLON,klev) ! op_ck_20031001
